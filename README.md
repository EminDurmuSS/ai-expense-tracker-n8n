...
1. **Clone the repository**
   ```bash
   git clone https://github.com/emindurmus/ai-expense-tracker-n8n.git
...
📁 [Open the Drive Folder](https://drive.google.com/drive/folders/1A9SRkoPBwOs4A7cf26j3QomEcP5dI9Sm?usp=sharing)
...
📈 [Open the Google Sheets Template](https://docs.google.com/spreadsheets/d/1h_xhUSolPzLiu2tuHJi6ZQ9eL529YTIR/edit?usp=sharing)

Or click **[Make a Copy](https://docs.google.com/spreadsheets/d/1h_xhUSolPzLiu2tuHJi6ZQ9eL529YTIR/copy)** to create your own editable version.
...
- **Name:** Emin Durmuş
- 🔗 [LinkedIn](https://www.linkedin.com/in/emin-durmus/)
